<div class="col-sm-3 blog-sidebar">
    ...
    <#else>
        <div class="sidebar-module" style="position: relative;">
            <a <#--href='https://gitee.com/yadong.zhang/DBlog'--> target="_blank" rel="external nofollow"><img src='https://gitee.com/yadong.zhang/DBlog/widgets/widget_1.svg?color=07b83f' alt='show me the code' style="position: absolute;right: 0;"/></a>
                ...
                <div id="feed_widget">
                    <div class="feed-about">
                        <div class="about-main">
                            ...
                            <div class="about-the" style="text-align: center;color: #91c24f">${config.siteDesc!}</div>
                        </div>
                        <div class="clear"></div>
                        <!-- 方案一：图标展示 -->
    ...
    <div style="margin-bottom: 10px">
        <a href="http://littlecong.xyz:8088/" target="_blank"><img src="https://2018cqu.oss-cn-beijing.aliyuncs.com/tit.gif" height="200px" width="100%"></a>
    </div>
